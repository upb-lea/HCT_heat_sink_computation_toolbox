...
constants = hct.init_constants(temperature)
...
for volume_flow_v_dot in volume_flow_v_dot_list:
    r_th_sa = hct.calc_final_r_th_s_a(geometry=geometry, constants=constants, t_ambient=temperature, volume_flow_v_dot=volume_flow_v_dot)
